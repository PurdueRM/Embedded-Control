...
extern DM_Motor_Handle_t *g_shoulder;
float shoulder_init;
...
const uint8_t uxTopUsedPriority __attribute__((used)) = configMAX_PRIORITIES;
...
void Robot_Init()
{
    ...
    // Initialize hardware before starting tasks that use it.
...
void Process_Remote_Input()
{
    ...
    g_robot_state.chassis.omega = 2 * g_remote.controller.right_stick.x/660.0f;
